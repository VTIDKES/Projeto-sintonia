...
def processar_diagrama_blocos():
    ...
    try:
        ...
        # Processar conexões para criar sistema completo
        ...
        return sistema_final, f"Sistema com {len(blocos_diagrama)} blocos processados"
...
def main():
    ...
    if st.session_state.modo_editor == 'visual':
        ...
        components.html(html_editor, height=750, scrolling=False)
        ...
        with col1:
            if st.button("⚡ Analisar Sistema", type="primary", use_container_width=True):
                ...
                if sistema:
                    ...
                    tab1, tab2, tab3, tab4 = st.tabs(["📈 Resposta Temporal", "📊 Bode", "🎯 Polos e Zeros", "🔄 LGR"])
                    ...
                    with tab4:
                        try:
                            ...
                            st.warning("⚠️ Não foi possível gerar o LGR para este sistema")
                else:
                    st.error(f"❌ {msg}")
